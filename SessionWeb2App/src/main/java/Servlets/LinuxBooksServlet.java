 ...
 * @author DELL
 */
@WebServlet(name = "LinuxBooksServlet", urlPatterns = {"/LinuxBooksServlet"})
public class LinuxBooksServlet extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.println("<FORM NAME='frmLinuxBooks' METHOD='post' ACTION='/SessionWeb2App/LinuxBooksServlet'>");
