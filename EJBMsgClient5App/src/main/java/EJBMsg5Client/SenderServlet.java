    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Queue qu = (Queue) ic.lookup("jms/queue");
                QueueConnectionFactory qf = (QueueConnectionFactory) ic.lookup("jms/queueFactory");
                ...
                Topic topic = (Topic) ic1.lookup("jms/topic");
                TopicConnectionFactory tf = (TopicConnectionFactory) ic1.lookup("jms/topicFactory");
                ...
                TextMessage tmm = tsession.createTextMessage();
                tmm.setText("I am a topic message from Sender Servlet");
                tp.publish(tmm);
                tcon.start();
            } catch (Exception e) {
                e.printStackTrace();
